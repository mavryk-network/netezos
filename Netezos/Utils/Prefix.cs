namespace Netezos
{
    static class Prefix
    {
        ...
        /// </summary>
        public static readonly byte[] mv1 = new byte[] { 5, 186, 196 };

        /// <summary>
        /// Address prefix for Secp256k1
        /// </summary>
        public static readonly byte[] mv2 = new byte[] { 5, 186, 199 };

        /// <summary>
        /// Address prefix for Nistp256
        /// </summary>
        public static readonly byte[] mv3 = new byte[] { 5, 186, 201 };

        /// <summary>
        /// Address prefix for BLS12-381
        /// </summary>
        public static readonly byte[] mv4 = new byte[] { 5, 186, 204 };
